...
## 📌 프로젝트 소개
**SOLT**는 혼자 여행하는 사람들을 위한 AI 기반 여행 플래너 서비스입니다.

여행 일정을 계획하는 데에 어려움을 느끼는 사용자들을 위해 AI가 개인 맞춤형 여행 일정을 추천하고, 여행지에 대한 정보와 커뮤니티 기능을 통해 사용자 간의 경험을 공유할 수 있도록 돕습니다.

SOLT는 여행 계획에 대한 부담을 덜고, 혼자 떠나는 여행을 더 특별하고 효율적으로 만들어주는 것을 목표로 합니다.
